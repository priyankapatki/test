...
def f06(string1, string2):
    ...
    if len_string1 > len_string2:
        len_diff = len_string1 - len_string2
        perc_char = (len_string2/len_string1) * 100
        print("{} is longer than {} by {} chars.".format(string1, 
        repr(string2), repr(x)))
        print("{} has only {} % the number of chars of {}".format(string1, repr(perc_char), repr(string2)))
    else:
        len_diff = len_string2 - len_string1
        perc_char = (len_string1/len_string2) * 100
        print("{} is longer than {} by {} chars.".format(string2, 
            repr(string1), repr(x)))
        print("{} has only {} % the number of chars of {}".format(string1, repr(perc_char), repr(string2)) )
...
def f09():
    sum = 0
    multiples = [num for num in range(501) if num % 3 == 0 or num % 5 == 0]
    sum = sum(multiples)
...
def f11(args):
    if 'str' in str(type(arg)):
        ...
        print("{}".format(float(arg)))
    elif'float' in str(type(arg)):
        print("{}".format(int(arg)))
    else:
        print(0)
